...
$api_url = "https://cloud.taximachine.com.br/api/integracao/solicitacao?empresa_id=42458&data_hora_solicitacao_min=$data_hora_menos_2_formatada&data_hora_solicitacao_max=$data_hora_atual_formatada";
    ...
    try {
        ...
        foreach ($orders as $order) {
            ...
            foreach ($order['paradas'] as $parada) {
                ...
                sendTelegramMessage("DECK BIBS - Parada inserida com sucesso. ID da parada: $parada_id_inserted");
            }
        ...
        // Commit da transação
        $pdo->commit();
        sendTelegramMessage("DECK BIBS - Solicitação e paradas inseridas com sucesso!");
        $logger->sendLog("DECK BIBS - Dados inseridos no banco de dados com sucesso");
